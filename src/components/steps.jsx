...
import Car from '../imgs/usage/car.png';
import { getItems, getItem } from '../components/tips/water.js';
    ...
    return (
      ...
      >
        ...
        <svg
          ...
          style={this.getStyle()}
        >
          <rect x="0" y="0" width="140" height="300" style={{ fill: 'red' }} />
          {this.getContent()}
        </svg>
